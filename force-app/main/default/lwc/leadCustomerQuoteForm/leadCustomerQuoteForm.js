...
export default class LeadCustomerQuoteForm extends LightningElement {
  logo = logo;
    @track selectedOption = 'RequestforQuoteForm'; // Set default value
    ...
    accountOptions = [
        { label: 'Request for Quote Form', value: 'RequestforQuoteForm' }
    ];
